...
uint32_t br_sphincs_p_third_party_vrfy(const br_sphincs_p_public_key *pk,
    ...
    case sha256_128f_robust:
        rc = OQS_SIG_sphincs_sha256_128f_robust_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_128f_simple:
        rc = OQS_SIG_sphincs_sha256_128f_simple_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_128s_robust:
        rc = OQS_SIG_sphincs_sha256_128s_robust_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_128s_simple:
        rc = OQS_SIG_sphincs_sha256_128s_simple_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_192f_robust:
        rc = OQS_SIG_sphincs_sha256_192f_robust_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_192f_simple:
        rc = OQS_SIG_sphincs_sha256_192f_simple_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_192s_robust:
        rc = OQS_SIG_sphincs_sha256_192s_robust_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_192s_simple:
        rc = OQS_SIG_sphincs_sha256_192s_simple_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_256f_robust:
        rc = OQS_SIG_sphincs_sha256_256f_robust_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_256f_simple:
        rc = OQS_SIG_sphincs_sha256_256f_simple_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_256s_robust:
        rc = OQS_SIG_sphincs_sha256_256s_robust_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
    case sha256_256s_simple:
        rc = OQS_SIG_sphincs_sha256_256s_simple_verify(msg, msg_len, sig, sig_len, pk->k);
        if (rc == OQS_SUCCESS) {
            return 1;
        }
        break;
